void processCompanyMaster()
{
	...
	[
		...
		to :sendTo
		subject :"Company Master Successfully Processed on " + zoho.currentdate.toString("dd-MM-yyyy")
		message :message
	]
}

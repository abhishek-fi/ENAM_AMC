// Company Universe - Edited - Update of L2 FM3 Status - Send Email on L2 FM3 Status
// Execute only if L2_FM3_Status == "Clarification Needed" || L2_FM3_Status == "Rejected" 
...
// Execute only if L2_FM3_Status == "Re-Submit"
fm_dt = input.L2_FM3_Name;
// info fm_dt;
email = input.L2_FM3_Name.Email_Id;
// info email;
record_link = "https://creatorapp.zoho.in" + zoho.appuri + "#Page:Universe_Addition?recid=" + input.ID;

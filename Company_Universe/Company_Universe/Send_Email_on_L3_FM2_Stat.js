// Company UniverseEditedUpdate of L3 FM2 StatusSend Email on L3 FM2 Status
// Execute only if L3_FM2_Status == "Clarification Needed" || L3_FM2_Status == "Rejected" 
...
// Execute only if L3_FM2_Status == "Re-Submit"
fm_dt = input.L3_FM2_Name;
// info fm_dt;
email = input.L3_FM2_Name.Email_Id;
// info email;
record_link = "https://creatorapp.zoho.in" + zoho.appuri + "#Page:Universe_Addition?recid=" + input.ID;

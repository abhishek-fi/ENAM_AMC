// Company Universe - Edited - Update of FM2 Status - Send Email on FM2 Status
// Execute only if FM2_Status == "Rejected" || FM2_Status == "Clarification Needed"
...
// Execute only if FM2_Status == "Re-Submit"
fm_dt = input.FM2_Name;
// info fm_dt;
email = input.FM2_Name.Email_Id;
// info email;
record_link = "https://creatorapp.zoho.in" + zoho.appuri + "#Page:Universe_Addition?recid=" + input.ID;
...
// Execute only if FM3_Status == "Approved" && FM2_Status == "Approved" && FM1_Status == "Approved" 

// Company Universe - Edited - Update of L2 FM1 Status - Send Email on L2 FM1 Status
// Execute only if L2_FM1_Status1 == "Rejected" || L2_FM1_Status1 == "Clarification Needed" 
...
// Execute only if L2_FM1_Status1 == "Re-Submit"
fm_dt = input.L2_FM1_Name;
// info fm_dt;
email = input.L2_FM1_Name.Email_Id;
// info email;
record_link = "https://creatorapp.zoho.in" + zoho.appuri + "#Page:Universe_Addition?recid=" + input.ID;

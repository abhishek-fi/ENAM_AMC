// Company Universe - Edited - Update of L3 FM1 Status - Send Email On L3 FM1 Status
// Execute only if L3_FM1_Status == "Clarification Needed" || L3_FM1_Status == "Rejected
...
// Execute only if L3_FM1_Status == "Re-Submit"
fm_dt = input.L3_FM1_Name;
// info fm_dt;
email = input.L3_FM1_Name.Email_Id;
// info email;
record_link = "https://creatorapp.zoho.in" + zoho.appuri + "#Page:Universe_Addition?recid=" + input.ID;
...
// Execute only if L3_FM1_Status == "Approved" && L3_FM2_Status == "Approved" && L3_FM3_Status == "Approved"

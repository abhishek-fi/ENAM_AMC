// Company Universe - Edited - Update of FM1 Status - Send Email on FM1 Status
// Execute only if FM1_Status == "Rejected" || FM1_Status == "Clarification Needed"
...
// Execute only if FM1_Status == "Re-Submit"
fm_dt = input.FM1_Name;
// info fm_dt;
email = input.FM1_Name.Email_Id;
// info email;
record_link = "https://creatorapp.zoho.in" + zoho.appuri + "#Page:Universe_Addition?recid=" + input.ID;
...
// Execute only if FM1_Status == "Approved" && FM2_Status == "Approved" && FM3_Status == "Approved" 

// Company Universe - Edited - Update of L2 FM1 Name - Send approval email to l2 fm1
if(L2_FM1_Name != null)
{
...
[
	...
	subject :"Copy - " + subject + "for: " + input.L2_FM1_Name.Email_Id
	message :message
]

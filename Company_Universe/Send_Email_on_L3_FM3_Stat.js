// Company Universe - Edited - Update of L3 FM3 Status - Send Email on L3 FM3 Status
// Execute only if L3_FM3_Status == "Clarification Needed" || L3_FM3_Status == "Rejected"
...
// Execute only if L3_FM3_Status == "Re-Submit"
fm_dt = input.L3_FM3_Name;
// info fm_dt;
email = input.L3_FM3_Name.Email_Id;
// info email;
record_link = "https://creatorapp.zoho.in" + zoho.appuri + "#Page:Universe_Addition?recid=" + input.ID;

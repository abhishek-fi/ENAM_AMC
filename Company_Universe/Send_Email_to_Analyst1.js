// Company Universe - Edited - Update of FM 3 Status - Send Email to Analyst
// Execute only if FM3_Status == "Rejected" || FM3_Status == "Clarification Needed"
...
// Execute only if FM3_Status == "Re-Submit"
fm_dt = input.FM3_Name;
// info fm_dt;
email = input.FM3_Name.Email_Id;
// info email;
record_link = "https://creatorapp.zoho.in" + zoho.appuri + "#Page:Universe_Addition?recid=" + input.ID;

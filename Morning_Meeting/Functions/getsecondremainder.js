		...
		for each  att in attendances
		{
			...
			if(analyst_record != null && analyst_record.Email_Id != null && analyst_record.Email_Id != "" && analyst_record.Profile != "Fund Manager" && analyst_record.User_Status == "Active")
			{
				...
				[
					...
					subject :"Follow-Up Reminder:Meeting Attendance Still Not Marked"
					message :"Dear " + analyst_record.First_Name + ",<br><br>" + "This is a follow-up reminder that your meeting attendance is still missing.<br>" + "Please update your attendance.<br><br>" + buttons + "<b>Deadline:</b> " + tomorrow.toString("dd-MMM-yyyy") + " 9:30 AM<br><br>" + "Regards,<br>ENAM AMC Research Team"
				]
				att.Reminder_2=true;
			}
		}
